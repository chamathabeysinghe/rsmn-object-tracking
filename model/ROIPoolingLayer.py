...
# Verify ROI Pooling layer
# import numpy as np
# img = np.asarray([[[i*8+j for j in range(12)] for i in range(8)]])
# img = np.expand_dims(img, axis=3)
# print(img.shape)
# rois = np.asarray([[[0,0,.5,.5]]])
# print(rois.shape)
# img = tf.convert_to_tensor(img, dtype=tf.float32)
# rois = tf.convert_to_tensor(rois, dtype=tf.float32)
# roi_layer = ROIPoolingLayer(2,2)
# pool_data = roi_layer([img, rois])
# # pool_data[0,0,:,:,0]
#
